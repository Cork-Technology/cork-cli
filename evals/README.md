...
60 active tasks spanning reads, compute, prepare (bundles, maker orders incl. a decaying-premium
...
Cost note: the set grew 44 -> 55 active tasks in 2026-08 and to 60 on 2026-09-02, so a full run costs proportionally
