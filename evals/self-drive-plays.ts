...
export const PLAYS: Play[] = [
  ...
  { id: "answer-rfq-impairment", calls: [{ tool: "cork_prepare_orders", input: { chainId: 42161, account: A, clientRequestId: "answer-rfq-impairment-0001", action: { type: "answer-rfq", rfqId: RFQ_IMPAIRMENT_ID, premiumAnnualized: "0.04", expiryTimestamp: RFQ_IMPAIRMENT_EXPIRY } } }], finalText: "Sign the typed-data above (unsigned, nothing relayed). The order pins the impairment window the RFQ's inline block asked for, resolved at the live oracle rate 0.8: rateMin 798465753424657535, rateMax 801534246575342465, rateChangePerDayMax 219178082191780, rateChangeCapacityMax 1534246575342465." },
