...
export const TASKS: EvalTask[] = [
  ...
  { id: "gated-whitelist-list", prompt: "List ALL whitelisted addresses across Cork pools (the full enumeration, not a single-account check).", expect: { tool: "cork_query", params: { resource: "whitelisted-addresses" }, state: "unavailable", code: "needs_indexer", maxCalls: 2 } },
