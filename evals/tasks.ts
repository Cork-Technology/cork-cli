...
export const TASKS: EvalTask[] = [
  ...
  { id: "gated-orderbook", prompt: `Fetch the current Cork orderbook for pool ${P}.`, expect: { tool: "cork_query", params: { resource: "orderbook" }, state: "unavailable", code: "needs_indexer", answer: /indexer|not (yet )?(wired|available)|unavailable/i, maxCalls: 2 } },
  // ── compute ────────────────────────────────────────────────────────────
  ...
  { id: "gated-submit", prompt: `Submit this signed Cork order for me: {"order":"..."} with signature 0x1234, request id "eval-sub-0001".`, expect: { tool: "cork_submit", state: "unavailable", code: "phase_gated", answer: /not|unavailable|gated|cannot/i, maxCalls: 2 } },
  // ── decode / track ─────────────────────────────────────────────────────
  ...
  { id: "ho-authority", heldOut: true, prompt: `Prepare a Permit2 onboarding for token 0x9D39A5DE30e57443BfF2A8307A4256c8797A3497 spender 0xCCcCcCCCcccCBaD6F772a511B337d9CCc9570407, request id "eval-auth-0001".`, expect: { tool: "cork_prepare_phoenix", params: { action: { type: "authority-onboard" } }, state: "unavailable", code: "phase_gated", maxCalls: 2 } },
