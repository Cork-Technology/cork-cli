...
describe("deploymentProfiles in the bundled defaults", () => {
  ...
  // addresses on 42161 + 8453) is now the primary; the previous production stack — where
  // the venue's existing markets still live until it migrates — survives as arbitrum-v1.1,
  // and the pre-launch read-path pair as arbitrum-legacy.
