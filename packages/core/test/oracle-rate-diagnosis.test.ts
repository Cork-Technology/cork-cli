...
const ctx = (handler: (c: StubCall) => unknown): HandlerContext => ({ nowSeconds: 1_789_900_000n, generation: "cork/v0.3", resolveRpc: stubRpc(handler, { code: { [ORACLE.toLowerCase()]: "0x6001" } }) });
