    ...
    try {
      ...
      return envelope({
        ...
        data: {
          ...
          recipe,
          source,
          scales: { constraint: "ABSOLUTE rates, 1e18 = 1.0 — these four raw values are what a JIT order carries, in this order", rateOracle: "rate is ABSOLUTE, 1e18 = 1.0" },
          constraint,
  ...
  return envelope({
    ...
    data: {
      ...
      scales: {
        ...
        gasBumpEstimate: "1e7 base (under auction)",
        gasPriceEstimate: "1000 = 1 gwei (uint32, under auction)",
        fees: "1e5 base (integratorFee/resolverFee)",
        whitelistDiscountNumerator: "1e2 base",
        protocolSurplusFeePercent: "1e2 base (under fillability.surplus)",
