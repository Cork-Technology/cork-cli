...
export const TOOL_EXAMPLES: Record<ToolName, readonly ToolExample[]> = {
  cork_query: [
    ...
    { title: "Predict a market before it exists: pool id + cST/cPT + constraint for a pair (Arbitrum; recipe = the approved liquidity recipe CONTRACT of the primary cork/v0.4 generation; the fees are part of the 10-field id)", input: { resource: "derive-cork-pool", chainId: 42161, filters: { collateralAsset: "0x211Cc4DD073734dA055fbF44a2b4667d5E5fE5d2", referenceAsset: "0xdDb46999F8891663a8F2828d25298f70416d7610", expiry: "1900000000", recipe: "0x679Cbd016587c423f342e5Ba31e58356228c964d", args: "0x0000000000000000000000000000000000000000000000000de0b6b3a7640000", swapFeePercentage: "0", unwindSwapFeePercentage: "0" } } },
    ...
    { title: "The same read against the PREVIOUS (flat-wire, 0.3.3) generation — `generation` selects the set; every chain-backed input takes it", input: { resource: "registry-recipes", chainId: 42161, generation: "cork/v0.3" } },
