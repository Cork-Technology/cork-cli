...
export const TOOL_EXAMPLES: Record<ToolName, readonly ToolExample[]> = {
  cork_query: [
    ...
    { title: "Predict a market before it exists: pool id + cST/cPT + constraint for a pair (Arbitrum; recipe = the approved liquidity recipe CONTRACT)", input: { resource: "derive-cork-pool", chainId: 42161, filters: { collateralAsset: "0x211Cc4DD073734dA055fbF44a2b4667d5E5fE5d2", referenceAsset: "0xdDb46999F8891663a8F2828d25298f70416d7610", expiry: "1900000000", recipe: "0xb881DB48ad6DA84a8F0D1cE4150Caf7Ae016Dc55", args: "0x0000000000000000000000000000000000000000000000000de0b6b3a7640000" } } },
  ...
  cork_compute: [
    ...
    { title: "Ask a recipe what constraint it imposes on a pair — THE step that produces what a JIT order signs (Arbitrum)", input: { chainId: 42161, params: { kind: "recipe-rate-constraint", recipe: "0xb881DB48ad6DA84a8F0D1cE4150Caf7Ae016Dc55", collateralAsset: "0x211Cc4DD073734dA055fbF44a2b4667d5E5fE5d2", referenceAsset: "0xdDb46999F8891663a8F2828d25298f70416d7610", args: "0x0000000000000000000000000000000000000000000000000de0b6b3a7640000" } } },
