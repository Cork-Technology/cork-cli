...
lives on an older pool manager than the 10-field primary (176 on arbitrum-v1.1, 3 on
arbitrum-legacy, 6 on phoenix/v0.3-rc.1 Base, none yet on `0xcC17…`), so a read routed through the
